...
declare namespace chrome {
  ...
  namespace downloads {
    ...
    function download(options: DownloadOptions, callback: (downloadId: number | undefined) => void): void;
    function search(query: { id: number }, callback: (items: DownloadItem[]) => void): void;
    const onChanged: {
